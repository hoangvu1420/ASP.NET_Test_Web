    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 7, 6, 10, 51, 56, 548, DateTimeKind.Local).AddTicks(3039), 1, "Fiction" },
                    { 2, new DateTime(2025, 7, 6, 10, 51, 56, 548, DateTimeKind.Local).AddTicks(3064), 2, "Non-Fiction" },
                    { 3, new DateTime(2025, 7, 6, 10, 51, 56, 548, DateTimeKind.Local).AddTicks(3065), 3, "Science Fiction" },
                    { 4, new DateTime(2025, 7, 6, 10, 51, 56, 548, DateTimeKind.Local).AddTicks(3067), 4, "Mystery" },
                    { 5, new DateTime(2025, 7, 6, 10, 51, 56, 548, DateTimeKind.Local).AddTicks(3068), 5, "Horror" },
                    { 6, new DateTime(2025, 7, 6, 10, 51, 56, 548, DateTimeKind.Local).AddTicks(3071), 6, "Romance" }
                });
